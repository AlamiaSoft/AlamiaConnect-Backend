    ...
    'installer' => [
        'index' => [
            ...
            'installation-processing' => [
                'AlamiaConnect'       => 'Instalación de AlamiaConnect',
                'AlamiaConnect-info'  => 'Creando las tablas de la base de datos, esto puede tardar unos momentos',
                'title'        => 'Instalación',
            ],

            'installation-completed' => [
                'admin-panel'                => 'Panel de Administración',
                'AlamiaConnect-forums'              => 'Foro de AlamiaConnect',
                'customer-panel'             => 'Panel de Clientes',
                'explore-AlamiaConnect-extensions'  => 'Explorar Extensiones de AlamiaConnect',
                'title'                      => 'Instalación Completada',
                'title-info'                 => 'AlamiaConnect se ha instalado correctamente en su sistema.',
            ],

            'ready-for-installation' => [
                'create-databsae-table'   => 'Crear tabla de base de datos',
                'install'                 => 'Instalación',
                'install-info'            => 'AlamiaConnect Para la Instalación',
            ...
            'start' => [
                ...
                'title'         => 'Instalación de AlamiaConnect',
                'welcome-title' => 'Bienvenido a AlamiaConnect',
            ],
            ...
            'back'                     => 'Atrás',
            'AlamiaConnect'                   => 'AlamiaConnect',
            'AlamiaConnect-info'              => 'un Proyecto Comunitario de',
            'AlamiaConnect-logo'              => 'Logotipo de AlamiaConnect',
            'continue'                 => 'Continuar',
            'installation-description' => 'La instalación de AlamiaConnect generalmente implica varios pasos. Aquí hay un esquema general del proceso de instalación de AlamiaConnect.',
            ...
            'title'                    => 'Instalador de AlamiaConnect',
            'Alamia'                   => 'Alamia',
        ],
    ],
];
