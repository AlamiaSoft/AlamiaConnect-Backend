    ...
    'installer' => [
        'index' => [
            ...
            'installation-processing' => [
                'AlamiaConnect'       => 'نصب کرایین',
                'AlamiaConnect-info'  => 'در حال ایجاد جداول پایگاه داده، این ممکن است چند لحظه طول بکشد',
                'title'        => 'نصب',
            ],

            'installation-completed' => [
                'admin-panel'                => 'پنل مدیریت',
                'AlamiaConnect-forums'              => 'انجمن کرایین',
                'customer-panel'             => 'پنل مشتری',
                'explore-AlamiaConnect-extensions'  => 'کاوش افزونه‌های کرایین',
                'title'                      => 'نصب کامل شد',
            ...
            'back'                     => 'بازگشت',
            'AlamiaConnect'                   => 'کرایین',
            'AlamiaConnect-info'              => 'یک پروژه اجتماعی توسط',
            'AlamiaConnect-logo'              => 'لوگوی کرایین',
            'continue'                 => 'ادامه',
