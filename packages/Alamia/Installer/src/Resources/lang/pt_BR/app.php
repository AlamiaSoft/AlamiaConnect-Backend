    ...
    'installer' => [
        'index' => [
            ...
            'installation-processing' => [
                'AlamiaConnect'       => 'Instalação do AlamiaConnect',
                'AlamiaConnect-info'  => 'Criando as tabelas do banco de dados, isso pode levar alguns momentos',
                'title'        => 'Instalação',
            ],

            'installation-completed' => [
                'admin-panel'                => 'Painel de Administração',
                'AlamiaConnect-forums'              => 'Fórum AlamiaConnect',
                'customer-panel'             => 'Painel do Cliente',
                'explore-AlamiaConnect-extensions'  => 'Explorar Extensões AlamiaConnect',
                'title'                      => 'Instalação Concluída',
                'title-info'                 => 'AlamiaConnect foi instalado com sucesso no seu sistema.',
            ],
            ...
            'start' => [
                ...
                'title'         => 'Instalação do AlamiaConnect',
                'welcome-title' => 'Bem-vindo ao AlamiaConnect',
            ],
            ...
            'back'                     => 'Voltar',
            'AlamiaConnect'                   => 'AlamiaConnect',
            'AlamiaConnect-info'              => 'um projeto comunitário de',
            'AlamiaConnect-logo'              => 'Logotipo AlamiaConnect',
            'continue'                 => 'Continuar',
            'installation-description' => 'A instalação do AlamiaConnect geralmente envolve várias etapas. Aqui está uma visão geral do processo de instalação do AlamiaConnect',
            ...
            'title'                    => 'Instalador do AlamiaConnect',
            'Alamia'                   => 'Alamia',
        ],
    ],
];
