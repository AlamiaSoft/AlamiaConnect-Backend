    ...
    'installer' => [
        'index' => [
            ...
            'installation-processing' => [
                'AlamiaConnect'       => 'تثبيت AlamiaConnect',
                'AlamiaConnect-info'  => 'إنشاء جداول قاعدة البيانات، وقد يستغرق ذلك بضع دقائق',
                'title'        => 'التثبيت',
            ],

            'installation-completed' => [
                'admin-panel'                => 'لوحة المشرف',
                'AlamiaConnect-forums'              => 'منتديات AlamiaConnect',
                'customer-panel'             => 'لوحة العميل',
                'explore-AlamiaConnect-extensions'  => 'استكشاف امتدادات AlamiaConnect',
                'title'                      => 'اكتمال التثبيت',
                'title-info'                 => 'تم تثبيت AlamiaConnect بنجاح على نظامك.',
            ],

            'ready-for-installation' => [
                'create-databsae-table'   => 'إنشاء جدول قاعدة البيانات',
                'install'                 => 'التثبيت',
                'install-info'            => 'AlamiaConnect للتثبيت',
            ...
            'start' => [
                ...
                'title'         => 'تثبيت AlamiaConnect الخاص بك',
                'welcome-title' => 'مرحبًا بك في AlamiaConnect',
            ],
            ...
            'back'                     => 'رجوع',
            'AlamiaConnect'                   => 'AlamiaConnect',
            'AlamiaConnect-info'              => 'مشروع مجتمعي من قبل',
            'AlamiaConnect-logo'              => 'شعار AlamiaConnect',
            'continue'                 => 'متابعة',
            'installation-description' => 'عادة ما تتضمن عملية تثبيت AlamiaConnect عدة خطوات. إليك نظرة عامة عامة على عملية التثبيت AlamiaConnect',
            'installation-info'        => 'نحن سعداء برؤيتك هنا!',
            'installation-title'       => 'مرحبًا بك في التثبيت',
            'installation-wizard'      => 'لغة معالج التثبيت',
            'title'                    => 'مثبت AlamiaConnect',
            'Alamia'                   => 'Alamia',
        ],
    ],
];
