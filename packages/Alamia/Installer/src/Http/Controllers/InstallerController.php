...
namespace Alamia\Installer\Http\Controllers;
...
use Alamia\Installer\Helpers\DatabaseManager;
use Alamia\Installer\Helpers\EnvironmentManager;
use Alamia\Installer\Helpers\ServerRequirements;
...
class InstallerController extends Controller
{
    ...
    private function smtpConfigSetup()
    {
        ...
        File::put($filePath, 'Your AlamiaConnect App is Successfully Installed');
