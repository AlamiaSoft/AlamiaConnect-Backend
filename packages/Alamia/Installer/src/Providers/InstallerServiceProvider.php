...
class InstallerServiceProvider extends ServiceProvider
{
    ...
    public function boot(Router $router): void
    {
        ...
        Event::listen('AlamiaConnect.installed', 'Alamia\Installer\Listeners\Installer@installed');
        ...
        $this->app['router']->get('cache/{filename}', [
            'uses' => 'Alamia\Installer\Http\Controllers\ImageCacheController@getImage',
            'as'   => 'image_cache',
        ])->where(['filename' => '[ \w\\.\\/\\-\\@\(\)\=]+']);
    }
