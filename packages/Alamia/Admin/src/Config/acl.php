...
return [
    ...
    [
        ...
        'name'  => 'admin::app.acl.delete',
        'route' => 'admin.inventory.delete',
        'sort'  => 3,
    ],
    [
        'key'   => 'service',
        'name'  => 'admin::app.acl.service',
    ...
    [
        ...
        'key'   => 'hr.delete',
        'name'  => 'admin::app.acl.delete',
        'route' => 'admin.hr.delete',
        'sort'  => 3,
    ],
    [
        'key'   => 'commissions',
        'name'  => 'admin::app.acl.commissions',
        'route' => 'admin.commissions.index',
        'sort'  => 12,
    ], [
        'key'   => 'maintenance',
        'name'  => 'admin::app.acl.maintenance',
        'route' => 'admin.maintenance.index',
        'sort'  => 13,
    ], [
        'key'   => 'sales_performance',
        'name'  => 'admin::app.acl.sales-performance',
        'route' => 'admin.sales_performance.index',
        'sort'  => 14,
    ],
    [
        'key'   => 'configuration',
