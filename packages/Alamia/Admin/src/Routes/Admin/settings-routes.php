...
use Alamia\Admin\Http\Controllers\Settings\AttributeController;
use Alamia\Admin\Http\Controllers\Settings\DataTransfer\ImportController;
use Alamia\Admin\Http\Controllers\Settings\EmailTemplateController;
use Alamia\Admin\Http\Controllers\Settings\GroupController;
use Alamia\Admin\Http\Controllers\Settings\LocationController;
use Alamia\Admin\Http\Controllers\Settings\Marketing\CampaignsController;
use Alamia\Admin\Http\Controllers\Settings\Marketing\EventController;
use Alamia\Admin\Http\Controllers\Settings\PipelineController;
use Alamia\Admin\Http\Controllers\Settings\RoleController;
use Alamia\Admin\Http\Controllers\Settings\SettingController;
use Alamia\Admin\Http\Controllers\Settings\SourceController;
use Alamia\Admin\Http\Controllers\Settings\TagController;
use Alamia\Admin\Http\Controllers\Settings\TypeController;
use Alamia\Admin\Http\Controllers\Settings\UserController;
use Alamia\Admin\Http\Controllers\Settings\Warehouse\ActivityController;
use Alamia\Admin\Http\Controllers\Settings\Warehouse\TagController as WarehouseTagController;
use Alamia\Admin\Http\Controllers\Settings\Warehouse\WarehouseController;
use Alamia\Admin\Http\Controllers\Settings\WebFormController;
use Alamia\Admin\Http\Controllers\Settings\WebhookController;
use Alamia\Admin\Http\Controllers\Settings\WorkflowController;
