        ...
        <div class="text-sm font-normal">
            {!! 
                trans('admin::app.components.layouts.powered-by.description', [
                    'alamia_connect' => '<a class="text-brandColor hover:underline " href="https://alamiaconnect.com/">' . trans('admin::app.components.layouts.powered-by.alamia_connect_name') . '</a>',
                    'alamiasoft'    => '<a class="text-brandColor hover:underline " href="https://www.alamiasoft.com/">' . trans('admin::app.components.layouts.powered-by.alamiasoft_name') . '</a>',
                ]) 
            !!}
        </div>
    </div>
