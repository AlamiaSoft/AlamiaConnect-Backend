    ...
    <div class="flex h-[100vh] flex-col items-center justify-center gap-10">
        ...
        <div class="text-sm font-normal">
            @lang('admin::app.components.layouts.powered-by.description', [
                'alamia_connect' => '<a class="text-brandColor hover:underline " href="https://www.alamiasoft.com/">AlamiaConnect</a>',
                'alamiasoft'    => '<a class="text-brandColor hover:underline " href="https://www.alamiasoft.com/">AlamiaSoft</a>',
            ]) 
        </div>
    </div>
</x-admin::layouts.anonymous>
