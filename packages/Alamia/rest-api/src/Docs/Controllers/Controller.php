...
namespace Alamia\RestApi\Docs\Controllers;

/**
 * @OA\Info(
 *      version="2.0.0",
 *      title="AlamiaConnect Rest API Documentation",
 *      description="AlamiaConnect Rest API Documentation",
 *
 *      @OA\Contact(
 ...
 * @OA\Server(
 *      url=APP_URL,
 *      description="AlamiaConnect Rest API."
 * )
 *
 * @OA\Tag(
 *     name="Authentication",
