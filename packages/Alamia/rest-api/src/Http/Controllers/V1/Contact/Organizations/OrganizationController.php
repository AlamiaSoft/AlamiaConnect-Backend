...
namespace Alamia\RestApi\Http\Controllers\V1\Contact\Organizations;
...
use Alamia\RestApi\Http\Resources\V1\Contact\OrganizationResource;
...
class OrganizationController extends Controller
{
    ...
    public function search()
    {
        $organizations = $this->organizationRepository
            ->pushCriteria(new \Alamia\RestApi\Http\Criteria\OrganizationSearchCriteria())
