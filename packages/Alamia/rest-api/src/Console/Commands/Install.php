...
namespace Alamia\RestApi\Console\Commands;
...
class Install extends Command
{
     ...
     * @var string
     */
    protected $signature = 'alamia-rest-api:install';
    ...
    public function handle()
    {
        ...
        exec('php artisan vendor:publish --provider="Alamia\RestApi\Providers\RestApiServiceProvider" --force', $output, $exitStatus);
